...
use Pluf\WP\CommentCollectionInterface;
...
class CommentCollection implements CommentCollectionInterface
{
    ...
    public function init()
    {
        ...
        $this->assertTrue(is_dir($pathname) || mkdir($pathname), 'Impossilbe to create comments directory {{pathname}} for local cms.', [
            'pathname' => $pathname
        ]);
    }
    ...
    {
        return $this->parent->getPath() . '/comments';
    }
