...
class Style
{
    ...
    {
        $this->addByArray(self::NORMAL, [
            'fg' => 'normal'
        ])
            ->
        // 不明显的 浅灰色的
        addByArray(self::FAINTLY, [
            'fg' => 'normal',
            'options' => [
                'italic'
            ]
        ])
            ->addByArray(self::BOLD, [
            'options' => [
                'bold'
            ]
        ])
            ->addByArray(self::INFO, [
            'fg' => 'green'
        ])
            -> // 'options' => ['bold']
        addByArray(self::NOTE, [
            'fg' => 'cyan',
            'options' => [
                'bold'
            ]
        ...
        addByArray(self::PRIMARY, [
            ...
            -> //
        addByArray(self::SUCCESS, [
            'fg' => 'green',
            'options' => [
                'bold'
            ]
        ])
            ->addByArray(self::NOTICE, [
            'options' => [
                'bold',
                'underscore'
            ]
        ])
            ->addByArray(self::WARNING, [
            'fg' => 'black',
            'bg' => 'yellow'
        ])
            -> // 'options' => ['bold']
        addByArray(self::COMMENT, [
            'fg' => 'yellow'
        ])
            -> // 'options' => ['bold']
        addByArray(self::QUESTION, [
            'fg' => 'black',
            'bg' => 'cyan'
        ])
            ->addByArray(self::DANGER, [
            'fg' => 'red'
        ])
            -> // 'bg' => 'magenta', 'options' => ['bold']
        add(self::ERROR, 'white', 'red', [], true)
            ->add('underline', 'normal', '', [
            'underscore'
        ])
            ->add('blue', 'blue')
            ->add('cyan', 'cyan')
     ...
     *
     * @param string $name
     * @param string|ColorCode|array $fg
     *            前景色|Color对象|也可以是style配置数组(@see self::addByArray())
